...
public class InventoryController {
	...
	public ResponseEntity<Product> save(@RequestBody Product product) throws JsonProcessingException {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<String> delete(@PathVariable("id") Long id) throws JsonProcessingException {
